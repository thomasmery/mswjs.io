...
_deprecation warning_: The _query_ property has been deprecated in favor of directly using `req.url.searchParams` which achieves the same thing and is closer to the [`URLSearchParams`](https://developer.mozilla.org/en-US/docs/Web/API/URLSearchParams)  syntax.
